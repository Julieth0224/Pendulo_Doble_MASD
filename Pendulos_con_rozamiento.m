function [outputArg1,outputArg2] = Pendulos_con_rozamiento(ti, tf, MLR, CI)
%%%% Multiples pendulos dobles con rozamiento

g = 9.8;

lims = max(MLR(:,2)) + max(MLR(:,4)) + 1;
